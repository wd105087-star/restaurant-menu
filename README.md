                    ...
                    optionsHtml = `
                        ...
                        <div class="option-group" style="padding-top: 0; border-top: none;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px 15px; margin-top: 5px;">
                                ...
                                <div class="opti            box-shadow: 0 2px 12px rgba(255, 87, 34, 0.1);
            margin-bottom: 24px;
        }
        h1 { 
            margin: 0; 
...
<body>
    ...
    <script>
        ...
        function showCategoryItems(cat) {
            ...
            // 修正邏輯：如果點擊當前已展開的類別，則收起並退出
            if (currentCategory === cat) {
                container.classList.remove('show');
                cards.forEach(card => card.classList.remove('active'));
                currentCategory = null;
                // 使用 requestAnimationFrame 確保樣式變更完成再清空內容
                requestAnimationFrame(() => { container.innerHTML = ''; }); 
                return;
            }
                    ...
                    optionsHtml = `
                        ...
                        <div class="option-group" style="padding-top: 0; border-top: none;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px 15px; margin-top: 5px;">
                                ...
                                <div class="option-group inline">
                                    <label for="${itemID}-grassjelly">仙草</label>
                                    <input type="checkbox" id="${itemID}-            border-radius: 12px;
            box-shadow: 0 2px 12px rgba(255, 87, 34, 0.1);
            margin-bottom: 24px;
        }
        h1 { 
...
<body>
    ...
    <script>
        ...
        // 【重要修正點：重新整理 showCategoryItems 函數邏輯】
        function showCategoryItems(cat) {
            const container = document.getElementById('itemsContainer');
            const cards = document.querySelectorAll('.category-card');
            const items = menuData[cat] || [];
                    ...
                    optionsHtml = `
                        ...
                        <div class="option-group" style="padding-top: 0; border-top: none;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px 15px; margin-top: 5px;">
                                ...
                                <div class="option-gro            border-radius: 8px;
            cursor: pointer;
            font-weight: 500;
            transition: transform 0.2s, box-shadow 0.2s;
            text-decoration: none !important;
...
<body>
    ...
    <script>
                    ...
                    optionsHtml = `
                        ...
                        <div class="option-group" style="padding-top: 0; border-top: none;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px 15px; margin-top: 5px;">
                                ...
                                <div class="option-gro            border-radius: 12px;
            box-shadow: 0 2px 12px rgba(255, 87, 34, 0.1);
            margin-bottom: 24px;
        }
        h1 { 
        ...
        .cart-item-controls {
            ...
            gap: 8px;
            width: 100%; /* 確保控制項佔滿寬度 */
            justify-content: space-between; /* 讓價格和按鈕分開 */
        }
        .cart-item-qty-controls {
            display: flex;
            gap: 5px;
            ...
            container.innerHTML = items.map((it, index) => {
                ...
                return `
                    <div class="item-card">
                        ...
                        ${optionsHtml} <div style="display:flex; gap:8px; al            border-radius: 12px;
            box-shadow: 0 2px 12px rgba(255, 87, 34, 0.1);
            margin-bottom: 24px;
        }
        h1 { 
